...
export const api = {
  ...
  passkeyRegisterOptions: () => request("GET", "/api/passkeys/register-options"),
  passkeyRegisterVerify: (resp) => request("POST", "/api/passkeys/register-verify", resp),
  passkeyLoginOptions: () => request("GET", "/api/passkeys/login-options"),
  passkeyLoginVerify: (resp) => request("POST", "/api/passkeys/login-verify", resp),
  passkeys: () => request("GET", "/api/passkeys"),
  deletePasskey: (id) => request("DELETE", `/api/passkeys/${id}`),
